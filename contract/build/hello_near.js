...
let Contract = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = call({}), _dec4 = view(), _dec5 = view(), _dec6 = view(), _dec7 = view(), _dec(_class = (_class2 = class Contract {
  constructor() {
    this.token_id = 0;
    this.owner_id = "";
...
function get_all_tokens_in_range() {
  ...
  const _result = _contract.get_all_tokens_in_range(_args);
...
export { get_all_tokens, get_all_tokens_in_range, get_supply_tokens, get_token_by_id, init, mint_nft };
